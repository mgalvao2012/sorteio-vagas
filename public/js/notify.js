...
function Notify(o) {
  ...
  this.notifyCreate = (style, head, content, sound) => {
    ...
    if (!content) {
      ...
      if (style == "info") {
        head = '<i class="fa fa-info-circle"></i> ' + head;
      }
      if (style == "success") {
        head = '<i class="fa fa-check-circle-o"></i> ' + head;
      }
      if (style == "warning") {
        head = '<i class="fa fa-exclamation-circle"></i> ' + head;
      }
      if (style == "error") {
        head = '<i class="fa fa-exclamation-triangle"></i> ' + head;
      }
